...
import { fetchImage, ImageDetails } from "../util/api";
  ...
  return (
    <>
      <div className='float-container'>
        {imgDetails && (
          <>
            <img className="float-child" src={imgDetails[0].webformatURL} alt={imgDetails[0].id.toString()} key={imgDetails[0].id}></img>
            <div className="float-child">
              ...
              <b className="big-text">{imgDetails[0].user}</b>
            </div>
            <div className="float-child">
              ...
              <b className="big-text">{imgDetails[0].likes}</b>
            </div>
            <div className="float-child">
              ...
              <b className="big-text">{imgDetails[0].downloads}</b>
            </div>
            <div className="float-child">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-binoculars" viewBox="0 0 16 16">
              ...
              <b className="big-text">{imgDetails[0].views}</b>
            </div>
            <div className="float-child">
              <b className="big-text">Tags: </b>
              <b className="big-text">{imgDetails[0].tags}</b>
            </div>
          </>
        )}
